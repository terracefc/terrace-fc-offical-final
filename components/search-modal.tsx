...
export function SearchModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex items-start justify-center pt-24 px-4">
      ...
      {/* Modal panel */}
      <div className="w-full max-w-2xl transform transition-all duration-300 ease-out bg-background text-black border border-border flex flex-col shadow-2xl rounded-3xl overflow-hidden relative z-10">
        ...
        <div className="p-6 border-b border-border flex items-center gap-4">
          ...
          <input 
            ...
            className="flex-1 bg-transparent border-0 outline-none text-lg placeholder:text-muted-foreground/60 !text-black font-medium"
            autoFocus
          />
          {searchQuery && (
            <button 
