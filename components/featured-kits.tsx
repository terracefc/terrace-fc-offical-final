...
import { getKitDisplayBadge, getKitOriginalPrice, getKitSalePrice, isEmbroideryOnlyKit, isRetroJersey, isWorldCup2026Kit } from "@/lib/pricing"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {displayKits.map((kit, index) => {
            ...
            const cardPrice = isMysteryKit ? salePrice : isSingleVersionProduct ? (testModeEnabled ? 1 : salePrice) : testModeEnabled ? 1 : JERSEY_VERSION_PRICES.fan
                          ...
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              addToCart(pricedKit, size, {
                                version: isRetroProduct ? "plain" : "fan",
