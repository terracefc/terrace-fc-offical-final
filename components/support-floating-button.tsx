  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-white px-1 text-[10px] font-black text-red-600 ring-2 ring-black">
          1
        </span>
      </button>
