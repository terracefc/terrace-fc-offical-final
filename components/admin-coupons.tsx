    ...
    <div className="grid gap-6 md:grid-cols-[340px_1fr]">
      <div className="h-fit rounded-2xl border border-border bg-background/85 p-5 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="-mt-2 text-[10px] font-bold text-muted-foreground">Coupons are one use per account by default. Clear either field only when you explicitly want it to be infinite.</p>
