...
import { EMBROIDERY_ONLY_PRICE, getKitDisplayBadge, getKitSalePrice, isEmbroideryOnlyKit } from "@/lib/pricing"
...
export default function KitDetailPage() {
  ...
  const selectedBackOption = isCurrentWorldCupKit ? backOption : isClubJersey || backOption === "custom" ? "plain" : backOption
  ...
  const preparationLeadTimeDays = 3 + (!isMysteryKit && !isEmbroideredSelected && backOption !== "plain" ? 3 : 0)
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-sm text-muted-foreground font-medium mb-3">
                {isMysteryKit ? "One surprise World Cup jersey" : isF1Product ? `${kit.club} F1 teamwear` : isKidsProduct ? `${kit.club} kids jersey` : isJacketProduct ? `${kit.club} track jacket` : getVersionSummary(version, kit.club, isEmbroideryOnly)}
              </p>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-4 sm:gap-2">
                {([
                  ...
                  ["master", "Master", getJerseyVersionBasePrice(kit, "master", testModeEnabled, "plain"), "Embroidered logos with heat-pressed sponsors, names, and numbers. Comes with shorts."],
...
function getVersionDetail(version: JerseyVersion, isEmbroideryOnly = false) {
  ...
  if (version === "master") return "Master Version: embroidered logos with heat-pressed sponsors, names, and numbers. Comes with shorts. Original and custom back names are available as add-ons."
