...
export function mapOrderRow(row: any): StoreOrder {
  ...
  return {
    ...
    trackingNumber: addressMeta.delhiveryWaybill || row.tracking_number || addressMeta.trackingNumber || row.shipping_id,
    courierName: addressMeta.delhiveryWaybill || addressMeta.shippingProvider === "delhivery"
      ? "Delhivery"
      : row.courier_name || addressMeta.courierName,
    estimatedDelivery: row.estimated_delivery || addressMeta.estimatedDelivery,
    shippingId: addressMeta.delhiveryWaybill || row.shipping_id || row.tracking_number || addressMeta.trackingNumber,
    ...
    delhiveryWaybill: addressMeta.delhiveryWaybill,
